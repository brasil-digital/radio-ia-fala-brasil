# ============================================================
#  Gerador de Spots/Vinhetas — Voz da BIANCA POWER
#  Voz: Voice Design ElevenLabs (personagem oficial do ecossistema)
#
#  Uso:
#    .\gerar-spot-bianca.ps1 -Texto "..." -Arquivo "Vinheta-Bianca-Nome.mp3"
#
...
$VoiceId    = 'STVztoMqdqzunoNLiqCl'   # Bianca Power
...
$body = @{
  text     = $Texto
  model_id = $ModeloTts
  voice_settings = @{ stability = 0.45; similarity_boost = 0.8; style = 0.45 }
} | ConvertTo-Json -Depth 4

Write-Host "Gerando spot com a voz da Bianca Power..." -ForegroundColor Magenta
