    ...
    <div className="min-h-screen bg-radio-dark text-white">
      ...
      <section className="max-w-6xl mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400">14 artistas virtuais criados com IA — todos estilos do Brasil</p>
        </div>
      ...
      <section className="max-w-4xl mx-auto px-4 py-16 text-center">
        ...
        <p className="text-gray-300 text-lg leading-relaxed mb-4">
          ...
          100% criado por Inteligência Artificial. São 14 artistas virtuais, cada um com identidade,
        ...
        <div className="grid grid-cols-3 gap-6 mt-12">
          <div className="bg-radio-card border border-radio-green/40 rounded-xl p-6">
            <div className="font-display text-4xl font-bold text-radio-greenBright mb-1">14</div>
          ...
          <div className="bg-radio-card border border-radio-yellow/40 rounded-xl p-6">
            <div className="font-display text-4xl font-bold text-radio-yellow mb-1">700</div>
